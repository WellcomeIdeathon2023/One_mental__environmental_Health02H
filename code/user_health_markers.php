<?php    
    ...
    {	
        ...
        $sql = "SELECT *
                ...
                RIGHT JOIN 
                (SELECT state_code, deaths, cause_of_death_code, year(datetime) as `year`, cause_of_death
                FROM onehealth02h.daily_respiratory 
                WHERE cause_of_death_category = '".$opt[1]."') r
